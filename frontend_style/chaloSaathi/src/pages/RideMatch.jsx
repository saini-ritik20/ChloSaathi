...
// //   // ---------- WEBSOCKET ----------
// //   useEffect(() => {
// //     if (!searchArea || searchArea.length < 3) return;
...
// //     const ws = new WebSocket(`ws://127.0.0.1:8000/ws/drivers/${encodeURIComponent(searchArea.toLowerCase())}/`);
// //     wsRef.current = ws;
...
// //     axios.post(`http://127.0.0.1:8000/api/assign-ride/`, {
...
// //     axios.post(`http://127.0.0.1:8000/api/ride-confirmed/`, {
// //       driver_id: driverId,
...
//   // ---------- PICKUP LOCATION ----------
//   const handlePickupChange = (e) => {
//     const area = e.target.value; // keep spaces
//     setSearchArea(area);
...
//     // find matching city in the input
//     const locKey = Object.keys(locations).find((key) =>
//       area.toLowerCase().includes(key)
//     );

//     const loc = locKey ? locations[locKey] : locations.kanpur;
//     setPickupLocation({ ...loc, name: area });
//   };
...
//     // If customerDestination is an object with lat/lng, use it; else fallback to pickup location
//     const destLat = customerDestination.lat ?? pickupLocation.lat;
//     const destLng = customerDestination.lng ?? pickupLocation.lng;
...
//             placeholder="Enter destination..."
//             value={customerDestination}
//             onChange={(e) => setCustomerDestination(e.target.value)} // spaces allowed
//           />
//           <button className="search-ride-btn" onClick={handleCustomerRequest}>🔍 Find Ride</button>
//         </div>
//       )}
