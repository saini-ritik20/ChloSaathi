...
SECRET_KEY = 'django-insecure-fd6-4-9opx1i70+xg88p_znw01$t&&l!1i(l3-vog)760#))p5'
...
ASGI_APPLICATION = "ChaloSaathi.asgi.application"  # replace with your project module name
...
DATABASES = {
    'default': {
        ...
        "NAME": "taxiappdb",
        "USER": "chalosaathi",
        "PASSWORD": "RitikArpit1920",
        # 'NAME': os.getenv("taxiappdb"),
        # 'USER': os.getenv("ChaloSaathi"),
        # 'PASSWORD': os.getenv("RitikArpit@1920"),
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173", 
     'http://127.0.0.1:5173', # your React frontend
]
