...
from . import views
from taxiService.views import save_login, contact_view,customer_register,driver_register,available_drivers,start_ride_search
...
urlpatterns = [
    ...
    path("api/start-ride-search/", start_ride_search, name="start_ride_search"),
